...
<input type="hidden" name="items[name]" value="producto de prueba">
<input type="hidden" name="items[description]" value="descripción de producto de prueba">
<input type="hidden" name="items[unit_price]" value="1000">
<input type="hidden" name="items[quantity]" value="1">

<input type="hidden" name="customer[name]" value="Cliente de prueba">
<input type="hidden" name="customer[phone]" value="+52 1231231231">
<input type="hidden" name="customer[email]" value="prueba@mail.com">
